#!/bin/bash
#SBATCH --chdir=/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/diagnosis/normal_dementia/species/scripts
#SBATCH --output=/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/diagnosis/normal_dementia/species/slurm_out/%x.%a.out
...
path='/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/diagnosis/normal_dementia/species'
TABLEID="normal_dementia_birdman_l7_ft"

TABLE="/home/lakhatib/Wisconsin_MARS/metagenomics/data/diagnosis/normal_dementia/"$TABLEID".biom"
