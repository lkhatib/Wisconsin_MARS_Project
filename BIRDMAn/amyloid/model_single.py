...
MD = pd.read_table("/home/lakhatib/Wisconsin_MARS/metagenomics/data/amyloid/amyloid_birdman_metadata.tsv",
...
class ModelSingle(SingleFeatureModel):
    def __init__(
        ...
        **kwargs
        ...
        self.create_regression(formula="amyloid+mars_age+sex+bmi+bristol_type+age_diff_amyloid_mars+medication", metadata=MD)
