#!/bin/bash
#SBATCH --chdir=/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/amyloid/species/scripts
#SBATCH --output=/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/amyloid/species/slurm_out/%x.%a.out
...
path='/home/lakhatib/Wisconsin_MARS/metagenomics/birdman/amyloid/species'
TABLEID="amyloid_birdman_l7_ft"

TABLE="/home/lakhatib/Wisconsin_MARS/metagenomics/data/amyloid/"$TABLEID".biom"
