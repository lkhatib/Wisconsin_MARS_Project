...
MD = pd.read_table("/home/lakhatib/Wisconsin_MARS/metagenomics/data/apoe4/apoe4_birdman_metadata.tsv",
...
class ModelSingle(SingleFeatureModel):
    def __init__(
        ...
        **kwargs
        ...
        self.create_regression(formula="apoe4+mars_age+sex+bmi+bristol_type+medication", metadata=MD)
